...
class PengurusData {
  static List<Pengurus> daftarPengurus = [
    Pengurus(
      id: '1',
    ...
    Pengurus(
      id: '13',
      nama: 'Mochamad Rizal Ardiansyah Sucipno',
      jabatan: 'Kepala Divisi',
    ...
    Pengurus(
      id: '14',
      nama: 'Filipus Satrio Dewaki Tyasing Suryo',
      jabatan: 'Wakil Kepala Divisi',
      divisi: 'Competitive Programming',
    ...
    Pengurus(
      ...
      jabatan: 'Wakil Kepala Divisi',
      divisi: 'Project Manager',
      fotoUrl: 'assets/images/wakadiv_pm.jpeg',
      instagramLink: 'fhri_hdytllah07',
      deskripsiTugas: 'Mendampingi kepala divisi dalam mengelola dan mengkoordinasikan kegiatan divisi. Bertanggung jawab mengawasi pelaksanaan program kerja, serta menggantikan kepala divisi ketika berhalangan.',
    ),
  ];

  static Pengurus getKetua() {
    return daftarPengurus.firstWhere((p) => p.jabatan == 'Ketua ITC');
  }

  static Pengurus getWakilKetua() {
    return daftarPengurus.firstWhere((p) => p.jabatan == 'Wakil Ketua ITC');
  }

  static int getJumlahDivisi() {
    Set<String> divisiSet = daftarPengurus.map((p) => p.divisi).toSet();
    return divisiSet.length;
  }
}